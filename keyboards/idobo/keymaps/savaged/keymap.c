 ...
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------|
 * | \      | Q      | W      | E      | R      | T      | INS    | DEL    | Midclk | Y      | U      | I      | O      | P      | =      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+-----------------+--------|
 * | `      | A      | S      | D      | F      | G      | LALT   | CAP LK | RALT   | H      | J      | K      | L      | ;      | '      |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------------------------+--------|
 * | LSHIFT | Z      | X      | C      | V      | B      | [      | MENU   | ]      | N      | M      | ,      | .      | /      | RSHIFT |
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | PG UP  | PG DN  | BACKSP | FN     | TAB    | LGUI   | SPACE  | LGUI   | SPACE  | FN     | ENTER  | END    | HOME   | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */

 [_QW] = LAYOUT_ortho_5x15( /* QWERTY */
    KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_VOLD, KC_MUTE, KC_VOLU, KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    KC_MINS,
    KC_BSLS, KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_INS,  KC_DEL,  KC_BTN3, KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_EQL,
    ...
    KC_LCTL, KC_PGUP, KC_PGDN, KC_BSPC, MO(_FN), KC_TAB,  KC_LGUI, KC_SPC,  KC_LGUI, KC_SPC,  MO(_FN), KC_ENT,  KC_END,  KC_HOME, KC_RCTL
 ),

/* FUNCTION
 * .--------------------------------------------------------------------------------------------------------------------------------------.
 * | F12    | F1     | F2     | F3     | F4     | F5     | RGB-   |        | RGB+   | F6     | F7     | F8     | F9     | F10    | F11    |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        |        | UP     |        |        |        | RGB TG | RGB HD | RGB HI |        |        |        | PR SCR | SCR LK | PAUSE  |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * |        | LEFT   | DOWN   | RIGHT  |        |        |        | RGB SD | RGB SI | LEFT   | DOWN   | UP     | RIGHT  |        |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 * | PREV   | PLAY   | NEXT   | STOP   |        |        |        |        |        |        |        | CALC   | MYCOMP | MAIL   |        |
 * |--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------+--------|
 ...
 */
 ...
 [_FN] = LAYOUT_ortho_5x15( /* FUNCTION */
    KC_F12,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   RGB_VAD, _______, RGB_VAI, KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,
    ...
    KC_MPRV, KC_MPLY, KC_MNXT, KC_MSTP, _______, _______, KC_MSTP, _______, _______, _______, _______, KC_CALC, KC_MYCM, KC_MAIL, _______,
